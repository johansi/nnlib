...
class PointLearner:
    def __init__(self, root_path, images_path, size=(512,512), bs=-1, items_count=-1, gpu_id=0, 
                 ...
                 sample_img=None, true_positive_threshold=0.02,  lr=1e-03, file_filters_include=None, file_filters_exclude=None, clahe=False,
